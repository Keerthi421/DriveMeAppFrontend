          ...
          bookings
            ...
            .map((booking) => {
              if (booking.paymentDone)
                return <PaymentCard key={booking.id} item={booking} />;
            })
        )
      ) : (
...
const PaymentCard = ({ item }) => (
  <View style={styles.card}>
    <View style={styles.statusRow}>
      ...
      <Text style={styles.text}> To Driver</Text>
    </View>
    <View style={styles.statusRow}>
      <Text style={styles.btext}>
        {" "}
        {item?.preferences?.chargePerHour || 0} CAD
      </Text>
      <Text style={styles.btext}> {item?.driverDetails?.name}</Text>
    </View>
  </View>
);
